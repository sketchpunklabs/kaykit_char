...
const SpaceMouseCompact = {
    key     : 'SpaceMouse Compact',
    ...
    axes    : {
        panX    : { idx:0, type:'single' },
        panY    : { idx:1, type:'single' },
        pull    : { idx:2, type:'single' },
        tiltY   : { idx:3, type:'single' },
        tiltX   : { idx:4, type:'single' },
        twist   : { idx:5, type:'single' },
    },
}
